export const fetchMobilehead = async () => {
  let mobileheadphone = "";
  try {
    let data = await fetch("http://localhost:3004/mobileheadphone");
    let res = await data.json();
    mobileheadphone += `       
         <div class="sub_mobile-hedphone w-[90%] lg:w-[70%]  my-[10px] mx-auto lg:border-[1px] lg:border-solid lg:border-[lightgray] rounded-[10px] flex flex-row flex-wrap box-border justify-center items-center">
          <div class="child_sub_mobile-hedphone w-[90%] lg:w-[325px] h-[435px] box-border flex flex-col flex-wrap">
            ...
            <div class="image_child_sub_mobile-hedphone w-[292px] h-[298px] m-auto box-border">
              <a href="#" class="a_1_2_image_child_sub_mobile-hedphone w-[292px] h-[298px] flex flex-col flex-wrap">
                ...
                <div class="row_1_image_child_sub_mobile-hedphone w-[292px] h-[135px] flex justify-between flex-row flex-wrap">
                  ...
                  <hr class="columchild w-[1px] h-[100%] border-none border-l-[1px] border-l-solid border-l-[lightgray] opacity-[0.5]"/>
                  <div class="childrow_1_1_image_child_sub_mobile-hedphone w-[135px] h-[135px]">
    ...
    document.querySelector(".mobile-hedphone").innerHTML = mobileheadphone;
  } catch (error) {
